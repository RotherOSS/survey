...
sub Data {
    ...
    $Self->{Translation}->{'Please choose a Customer property to add a condition.'}
        = 'Моля, изберете свойство на клиента, за да добавите условие.';
    ...
    $Self->{Translation}->{'You have no permission for this survey or question!'}
        = 'Нямате разрешение за това проучване или въпрос!';
    $Self->{Translation}->{'You have no permission for this survey, question or answer!'}
        = 'Нямате разрешение за това проучване, въпрос или отговор!';
    ...
    $Self->{Translation}->{'You have no permission for this survey or stats detail!'}
        = 'Нямате разрешение за това проучване или статистически подробности!';
    $Self->{Translation}->{'Stats Detail'} = 'Подробности';

    # Perl Module: Kernel/Modules/AgentSurveyZoom.pm
    $Self->{Translation}->{'Can\'t set new status! No questions defined.'}
        = 'Не може да се зададе ново състояние! Няма дефинирани въпроси.';
    $Self->{Translation}->{'Can\'t set new status! Questions incomplete.'}
        = 'Не може да се зададе ново състояние! Въпроси непълни.';
    ...
    $Self->{Translation}->{'Defines the groups (rw) which can delete survey stats.'}
        = 'Дефинира групите (rw), които могат да изтриват статистически данни от проучването.';
    ...
    $Self->{Translation}->{'Enable or disable the send condition check for the service.'}
        = 'Активирайте или деактивирайте проверката на състоянието на изпращане за услугата.';
    ...
    $Self->{Translation}->{'If this regex matches, no customer survey will be sent.'}
        = 'Ако този регекс съвпада, няма да бъде изпратено проучване на клиентите.';
    $Self->{Translation}->{'Limit.'} = 'Лимит.';
    ...
    $Self->{Translation}->{
        ...
        =
        'Резултати, по-стари от конфигурирания брой дни, ще бъдат изтрити. Забележка: изтрийте резултатите, направени от OTOBO Daemon, преди активиране на настройката „Task###SurveyRequestsDelete“.';
    ...
    $Self->{Translation}->{'Survey limit per page for Survey Overview "Small".'}
        = 'Граница на изследването на страница за преглед на "Малки".';
    $Self->{Translation}->{'Surveys will not be sent to the configured email addresses.'}
        = 'Проучванията няма да бъдат изпратени до конфигурираните имейл адреси.';

...
sub Data {
    ...
    $Self->{Translation}->{'This doesn\'t have several answers, a textarea will be displayed.'} =
        'Esta pregunta no tiene varias respuestas, un área de texto será mostrada.';
    ...
    $Self->{Translation}->{'The inserted survey key is invalid, if you followed a link maybe this is obsolete or broken.'} =
        'La llave insertada de la encuesta es inválida, si ha seguido un enlace, quizá este obsoleta o rota.';
    ...
    $Self->{Translation}->{
        ...
        'Cantidad de días después de enviar un correo de encuesta en los que no se envían nuevas solicitudes de encuesta al mismo cliente. Si se selecciona 0 se enviará siempre el correo de la encuesta.';
    ...
    $Self->{Translation}->{
        ...
        =
        'Define la cantidad de horas que tiene que tener cerrar un ticket para disparar el envío de una encuesta, (0 significa mandar inmediatamente al cerrar). Nota: el envío retardado es realizado por el "OTOBO Daemon" una vez activado el ajuste \'Daemon::SchedulerCronTaskManager::Task###SurveyRequestsSend\'.';
    ...
    $Self->{Translation}->{'Defines the groups (rw) which can delete survey stats.'}
        = 'Define los grupos (rw) que podrán eliminar las estadísticas de las encuestas.';
    ...
    $Self->{Translation}->{'Enable or disable the send condition check for the service.'}
        = 'Activa o desactiva la comprobación de la condición de envío para el servicio.';
    ...
    $Self->{Translation}->{
        ...
        =
        'Los resultados más antiguos que la cantidad de días configurados, serán eliminados. Nota: eliminar los resultados es realizado por el "OTOBO Daemon" previa activación del ajuste \'Task###SurveyRequestsDelete\'.';
    ...
    $Self->{Translation}->{'Surveys will not be sent to the configured email addresses.'}
        = 'Las encuestas no de mandarán a las direcciones de correo electrónico aquí configuradas.';
    ...
    $Self->{Translation}->{'Trigger delete results (including vote data and requests).'}
        = 'Dispara la eliminación de resultados (incluyendo datos de votos y peticiones).';
